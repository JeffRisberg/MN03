...
public class CharityController {
  ...
  @Post
  public HttpResponse<Charity> save(@Body("name") @NotBlank String name) {
    Charity charity = charityRepository.save(name, "", "");
  ...
  @Post("/ex")
  public HttpResponse<Charity> saveExceptions(@Body @NotBlank String name) {
    try {
      Charity charity = charityRepository.saveWithException(name, "", "");
      return HttpResponse
        .created(charity)
        .headers(headers -> headers.location(location(charity.getId())));
